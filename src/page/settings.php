...
<div class="contents">
  ...
  <?php
  if(isset($_POST["save"])){
    $this->data->saveValue("startOnLobbyOpen", isset($_POST["startOnLobbyOpen"]) ? "1" : "0");
    echo sss("Saved", "Settings have been saved");
  }
  ?>
  <form method="POST" action="<?php echo \Lobby::u();?>">
    <label class="input-field">
      <input type="checkbox" name="startOnLobbyOpen" <?php echo $this->data->getValue("startOnLobbyOpen") === "1" ? "checked='checked'" : "";?> />
