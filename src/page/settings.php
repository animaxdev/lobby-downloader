...
<div class="contents">
  ...
  <?php
  if(isset($_POST["save"])){
    saveData("startOnLobbyOpen", isset($_POST["startOnLobbyOpen"]) ? "1" : "0");
    sss("Saved", "Settings have been saved");
  }
  ?>
  <form method="POST" action="<?php echo \Lobby::u();?>">
    <label class="input-field">
      <input type="checkbox" name="startOnLobbyOpen" <?php echo getData("startOnLobbyOpen") === "1" ? "checked='checked'" : "";?> />
